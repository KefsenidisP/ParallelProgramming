...
/*
 * MPSC: The program checks if the buffer is full, so there is no danger of eceeding its 
 * limit. Now, if there was a mutex regarding the locking of the delete function
 * between the threads that execute it, then it could have been removed. The code 
 * is left intact
*/
