...
/*
 * SPMC: This needs no change. But, if there was a lock for the add function only (not
 * the common buffer lock that exists right now) it could hav been removed, because we have
 * only one thread
*/
