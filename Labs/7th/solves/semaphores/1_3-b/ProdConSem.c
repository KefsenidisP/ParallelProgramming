 ...
 * Code for the MPSC.
 *
 * So this is the exact opposite of the SPMC code
*/
...
#define NPRO 3    // αριθμός παραγωγών
...
void queueDel (queue *q, int *out)
{
  ...
  /*
   * The buffer semaphore is used to guard the buffer from threads assigned 
   * to this function only. We have one thread only, so it can be removed.
   * The other to are too safeguard that the function will not be called when
   * the buffer is empty.
  */
