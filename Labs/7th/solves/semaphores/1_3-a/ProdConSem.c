 ...
 * Code foor SPMC
 *
 * Obly one producer means no buffer lock inside the put function 
*/
...
#define NCON 3    // αριθμός καταναλωτών
...
void queueAdd (queue *q, int in)
{
  ...
  /*
   * Only the full check semaphore is needed.
   * We have only one thread assigned to this function 
   * and it also controls the unlocking oof the get functiion
   * semaphore. At the get function the buffer seemaphore is needed
   * because we have 3 threads.
  */
